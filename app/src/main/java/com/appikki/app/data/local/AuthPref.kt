package com.appikki.app.data.local

import android.content.Context
import android.content.SharedPreferences
import android.provider.ContactsContract
import com.appikki.app.data.model.ActionState
import com.appikki.app.data.model.AuthUser
import com.appikki.app.util.getObject
import com.appikki.app.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser> {
        val user = authUser
        return if (user == null){
            ActionState(massage = "Anda belum erdaftar !!", isSuccess = false)
            ...
            ActionState(massage = "Email atau Password yang anda masukkan salah", isSuccess = false)
        }
    }
